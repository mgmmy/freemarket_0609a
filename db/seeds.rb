...
parent = Category.first_or_create(name: 'レディース')
lady_child_array.each_with_index do |child, i|
  child = parent.children.first_or_create(name: child)
  lady_grandchild_array[i].each do |grandchild|
    child.children.first_or_create(name: grandchild)
  end
end
...
parent = Category.first_or_create(name: 'メンズ')
...
parent = Category.first_or_create(name: 'ベビー・キッズ')
...
parent = Category.first_or_create(name: 'コスメ・香水')
...
parent = Category.first_or_create(name: 'その他')
...
parent = Size.first_or_create(size: 'mens_shoes')
mens_shoes_array.each_with_index do |child, i|
  child = parent.children.first_or_create(size: child)
end

CategorySize.first_or_create(category_id: 72, size_id: 12)

CategorySize.first_or_create(category_id: 270, size_id: 29)

clothes_array = ['2', '22', '45', '59', '66', '84', '184', '194', '203', '220', '234', '259', '294', '359', '371']

clothes_array.each_with_index do |size, i|
  size = CategorySize.first_or_create(category_id: size, size_id: 1)
end
